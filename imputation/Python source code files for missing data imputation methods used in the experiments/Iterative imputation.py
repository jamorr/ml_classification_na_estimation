...
df_after_IterativeImputer.to_csv("1% #5- Dataset-Without-Missing-After-IterativeImputer.csv",index=False ,sep=';', encoding='utf-8')
...
ws1['AF6'] = average_RMSE_All_Cols
ws1['AG6'] = average_NRMSE_All_Cols
ws1['AH6'] = average_AE_All_Cols
ws1['AI6'] = timeFinal
