...
all_dataset_imputed = kEMI(complete_data , X_incomplete)

timeFinal = (time.time() - start_time)
print("--- %s seconds ---" % timeFinal)

all_dataset_imputed.to_csv("1% #9- Dataset-Without-Missing-After-KEMI.csv",index=False ,sep=';', encoding='utf-8')
